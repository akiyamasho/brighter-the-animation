...
class App extends Component {
  ...
  componentDidMount() {
    ...
    this.refs.parallax.onScroll = evt => {
      ...
      this.setState({
        scrollOffset: Math.abs(current - space * (scrollBasedOffset + 1)) * 0.1,
      });
    };
  }
      ...
      <div>
        ...
        >
          ...
          <ParallaxLayer offset={2} {...parallaxPageProps}>
            {currentPageOffset === 2 && (
              <CharactersShe shouldPlayVideo={currentPageOffset === 2} />
            )}
          </ParallaxLayer>
          <ParallaxLayer offset={3} {...parallaxPageProps}>
            {currentPageOffset === 3 && (
              <CharactersHe shouldPlayVideo={currentPageOffset === 3} />
            )}
          </ParallaxLayer>
